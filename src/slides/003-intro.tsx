...
const Video = styled.div`
  ${tw`mx-auto w-full h-[fit-content] lg:(w-[80%]) xl:(w-[75%])`};
  ${tw`flex`};
`;

const P = tw.p`mx-auto font-sans font-bold text-white text-xl md:(text-2xl)  lg:(text-3xl) xl:(text-4xl) h-[fit-content] lg:(w-[80%] xl:(w-[75%]))`;
...
const GameplayIntro = () => {
  return (
    <Wrapper>
      <Video>
        <video poster="/video/gameplay.png" muted autoPlay loop playsInline>
